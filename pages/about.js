  ...
  return (
    <Layout>
      <div className={styles.pageContainer}>
        ...
        <p>I developed this app within a week before the hackathon ends. It is just a sketch or skeleton. In order to become a full-fledged application it is necessary to make the right architecture, to apply the necessary tools and make a proper UI/UX design. Due to winners announcement on or around October 10, 2022 I'm going to develop this app actively.</p>
        <h3>ToDo</h3>
