  ...
  return (
    <Layout>
      <div className={styles.pageContainer}>
        <h2>Hi there!</h2>
        <p>This application is a kind of dashboard, explorer or data visualisation bar designed to study and visualize Evmos Ecosystem data, smart-contracts, dapps, txs, coins, ibc movements etc.</p>
